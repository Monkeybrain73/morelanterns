...
namespace apelanterns
{
    ...
    public class BlockFloatingLantern : Block, IDrawYAdjustable //1.20
    {
        ...
        public override bool TryPlaceBlock(IWorldAccessor world, IPlayer byPlayer, ItemStack itemstack, BlockSelection blockSel, ref string failureCode)
        {
            ...
            if (blockSel.Face.IsHorizontal) //prevent placing on wall
            { return false; }

            var testBlock = this.api.World.BlockAccessor.GetBlock(blockSel.Position, BlockLayersAccess.Default);
            if (testBlock.Code.Path.Contains("water")) // prevent placing in partial water
            {
            ...
            if (testBlock2.Code.FirstCodePart() == "floatinglantern" || testBlock2.Code.FirstCodePart() == "raft") //prevent placing lantern on lantern or raft
            { return false; }
        ...
        public override void OnEntityCollide(IWorldAccessor world, Entity entity, BlockPos pos, BlockFacing facing, Vec3d collideSpeed, bool isImpact)
        {
            ...
            if (entity is EntityPlayer)
            {
                ...
                if (player is EntityPlayer)
                {
                    ...
                    var be = world.BlockAccessor.GetBlockEntity(pos) as BEFloatingLantern;
        ...
        public override void OnNeighbourBlockChange(IWorldAccessor world, BlockPos pos, BlockPos neibpos)
        {
            ...
            if (world.BlockAccessor.GetBlockEntity(pos) is BEFloatingLantern beBlock)
            {
                bool updated;
                if (thisBlock.FirstCodePart() == neibBlock.FirstCodePart())
                {
            ...
            if (world.BlockAccessor.GetBlockEntity(neibpos) is BEFloatingLantern bebBlock)
            {
                var updated = false;
                if (thisBlock.FirstCodePart() == neibBlock.FirstCodePart())
                {
        ...
        public override string GetPlacedBlockInfo(IWorldAccessor world, BlockPos pos, IPlayer forPlayer)
        {
            ...
            dsc.AppendLine(Lang.GetMatching("apelanterns:blockdesc-floatinglantern-*"));
